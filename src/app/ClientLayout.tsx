  ...
  return (
    <body className={`${inter} ${poppins} ${isLandingPage ? 'bg-white' : 'bg-slate-50'} text-slate-900 min-h-screen`}>
      <FirebaseProvider>
        ...
        <footer className={isLandingPage ? "w-full py-8 border-t border-slate-200 mt-16" : "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 border-t border-slate-200 mt-16"}>
